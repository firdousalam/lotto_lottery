...
var DatePicker = angular.module('date-pick',[]);

DatePicker.directive('datePick', ["$log", "$document", "$filter", fznDatePicker]);
...
function fznDatePicker ($log, $document, $filter) {
    ...
    var partials = {
        headTemplate : '<thead>'+
        '<tr>'+
        '<th class="prev"><i class="material-icons">Left</i></th>'+
        '<th colspan="5" class="date-switch"></th>'+
        '<th class="next"><i class="material-icons">Right</i></th>'+
        '</tr>'+
        '</thead>',
